...
if( $user->is_logged_in() ){ header('Location: velox_pages.php'); exit(); }
...
if(isset($_POST['submit'])){
	...
	if ( $user->isValidUsername($username)){
		...
		if($user->login($username,$password)){
			...
			header('Location: velox_pages.php');
			exit;
			...
			<form role="form" method="post" action="" autocomplete="off">
				...
				<div class="row">
					<div class="col-xs-9 col-sm-9 col-md-9">
						 <a href='resetPassword.php'>Forgot your Password?</a> | <a href='register.php'>Register</a>
					</div>
				</div>
